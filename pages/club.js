    ...
    <div>
      ...
      <div className="flex justify-center pt-14 pb-20">
        <div className="max-w-[786px]">
          <p className="font-bold text-4xl text-[#463F3A] text-center mb-6">
            Wyślij zgłoszenie
          </p>
          ...
          <div>
            ...
            <div className="flex flex-col items-start pb-[54px] border-b border-b-[#999999]">
              <span className="font-bold text-base text-[#463F3A] mb-6">
                Zajęcia
              </span>
              <Checkbox label="Gordonki" />
              <Checkbox label="Sensoryka" />
            </div>
            <div className="-mx-[15px] pt-8">
              <Checkbox
